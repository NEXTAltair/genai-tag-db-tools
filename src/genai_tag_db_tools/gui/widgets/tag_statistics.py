...
class TagStatisticsWidget(QWidget, Ui_TagStatisticsWidget):
    ...
    def update_distribution_chart(self, data: BarChartData | None) -> None:
        if data is None:
            return
    ...
    def update_usage_chart(self, data: PieChartData | None) -> None:
        if data is None:
            return
    ...
    def update_language_chart(self, data: BarChartData | None) -> None:
        if data is None:
            return
