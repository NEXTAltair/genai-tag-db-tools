...
class Ui_TagStatisticsWidget(object):
    ...
    def retranslateUi(self, TagStatisticsWidget):
        TagStatisticsWidget.setWindowTitle(
            QCoreApplication.translate("TagStatisticsWidget", "\u30bf\u30b0\u7d71\u8a08", None)
        )
        ...
        self.tabWidgetCharts.setTabText(
            ...
            QCoreApplication.translate("TagStatisticsWidget", "\u4f7f\u7528\u983b\u5ea6", None),
        )
        self.tabWidgetCharts.setTabText(
        ...
        self.tabWidgetCharts.setTabText(
            ...
            QCoreApplication.translate("TagStatisticsWidget", "\u30c8\u30ec\u30f3\u30c9", None),
        )
