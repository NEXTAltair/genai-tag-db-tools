...
class Ui_TagSearchWidget(object):
    def setupUi(self, TagSearchWidget):
        if not TagSearchWidget.objectName():
            TagSearchWidget.setObjectName("TagSearchWidget")
        ...
        self.groupBoxSearchCriteria.setObjectName("groupBoxSearchCriteria")
        ...
        self.groupBoxMatchType.setObjectName("groupBoxMatchType")
        ...
        self.groupBoxSavedSearches.setObjectName("groupBoxSavedSearches")
        ...
        self.comboBoxSavedSearches.setObjectName("comboBoxSavedSearches")
        ...
        self.pushButtonSaveSearch.setObjectName("pushButtonSaveSearch")
    ...
    def retranslateUi(self, TagSearchWidget):
        TagSearchWidget.setWindowTitle(
            QCoreApplication.translate("TagSearchWidget", "\u30bf\u30b0\u691c\u7d22", None)
        )
        self.groupBoxSearchCriteria.setTitle(
            QCoreApplication.translate("TagSearchWidget", "\u691c\u7d22\u6761\u4ef6", None)
        )
        self.lineEditKeyword.setPlaceholderText(
            QCoreApplication.translate(
                "TagSearchWidget", "\u30ad\u30fc\u30ef\u30fc\u30c9\u3092\u5165\u529b...", None
            )
        )
        self.groupBoxMatchType.setTitle(
            QCoreApplication.translate("TagSearchWidget", "\u4e00\u81f4\u30bf\u30a4\u30d7", None)
        )
        self.radioButtonExact.setText(
            QCoreApplication.translate("TagSearchWidget", "\u5b8c\u5168\u4e00\u81f4", None)
        )
        self.radioButtonPartial.setText(
            QCoreApplication.translate("TagSearchWidget", "\u90e8\u5206\u4e00\u81f4", None)
        )
        self.labelFormat.setText(
            QCoreApplication.translate("TagSearchWidget", "\u30d5\u30a9\u30fc\u30de\u30c3\u30c8:", None)
        )
        self.labelType.setText(QCoreApplication.translate("TagSearchWidget", "\u30bf\u30a4\u30d7:", None))
        self.labelLanguage.setText(QCoreApplication.translate("TagSearchWidget", "\u8a00\u8a9e:", None))
        self.labelUsageCount.setText(
            QCoreApplication.translate("TagSearchWidget", "\u4f7f\u7528\u56de\u6570:", None)
        )
        self.pushButtonSearch.setText(QCoreApplication.translate("TagSearchWidget", "\u691c\u7d22", None))
        self.groupBoxSavedSearches.setTitle(
            QCoreApplication.translate(
                "TagSearchWidget", "\u4fdd\u5b58\u3055\u308c\u305f\u691c\u7d22", None
            )
        )
        self.pushButtonSaveSearch.setText(
            QCoreApplication.translate(
                "TagSearchWidget", "\u73fe\u5728\u306e\u691c\u7d22\u3092\u4fdd\u5b58", None
            )
        )
        self.tabWidgetResults.setTabText(
            self.tabWidgetResults.indexOf(self.tabList),
            QCoreApplication.translate("TagSearchWidget", "\u30ea\u30b9\u30c8\u8868\u793a", None),
        )
        self.tabWidgetResults.setTabText(
            self.tabWidgetResults.indexOf(self.tabStatistics),
            QCoreApplication.translate("TagSearchWidget", "\u7d71\u8a08", None),
        )
