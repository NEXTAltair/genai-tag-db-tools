...
class Ui_TagDataImportDialog(object):
    def setupUi(self, TagDataImportDialog):
        if not TagDataImportDialog.objectName():
            TagDataImportDialog.setObjectName("TagDataImportDialog")
        ...
        self.requiredColumnsGroupBox.setObjectName("requiredColumnsGroupBox")
        ...
        self.sourceTagCheckBox.setObjectName("sourceTagCheckBox")
        ...
        self.translationTagsCheckBox.setObjectName("translationTagsCheckBox")
        ...
        self.deprecatedTagsCheckBox.setObjectName("deprecatedTagsCheckBox")
        ...
        self.dataPreviewGroupBox.setObjectName("dataPreviewGroupBox")
    ...
    def retranslateUi(self, TagDataImportDialog):
        TagDataImportDialog.setWindowTitle(
            QCoreApplication.translate(
                "TagDataImportDialog", "\u30bf\u30b0\u30c7\u30fc\u30bf\u30a4\u30f3\u30dd\u30fc\u30c8", None
            )
        )
        self.formatGroupBox.setTitle(
            QCoreApplication.translate("TagDataImportDialog", "\u30d5\u30a9\u30fc\u30de\u30c3\u30c8", None)
        )
        self.languageGroupBox.setTitle(
            QCoreApplication.translate("TagDataImportDialog", "\u8a00\u8a9e", None)
        )
        self.languageComboBox.setItemText(
            0, QCoreApplication.translate("TagDataImportDialog", "None", None)
        )

        self.requiredColumnsGroupBox.setTitle(
            QCoreApplication.translate("TagDataImportDialog", "\u5fc5\u9808\u30ab\u30e9\u30e0", None)
        )
        self.tagCheckBox.setText(QCoreApplication.translate("TagDataImportDialog", "tag", None))
        self.sourceTagCheckBox.setText(
            QCoreApplication.translate("TagDataImportDialog", "source_tag", None)
        )
        self.translationTagsCheckBox.setText(
            QCoreApplication.translate("TagDataImportDialog", "translation_tags", None)
        )
        self.deprecatedTagsCheckBox.setText(
            QCoreApplication.translate("TagDataImportDialog", "deprecated_tags", None)
        )
        self.dataPreviewGroupBox.setTitle(
            QCoreApplication.translate(
                "TagDataImportDialog",
                "\u30c7\u30fc\u30bf\u30d7\u30ec\u30d3\u30e5\u30fc\uff08\u53f3\u30af\u30ea\u30c3\u30af\u3067\u30ab\u30e9\u30e0\u306e\u7a2e\u985e\u3092\u9078\u629e\uff09",
                None,
            )
        )
        self.importButton.setText(
            QCoreApplication.translate("TagDataImportDialog", "\u30a4\u30f3\u30dd\u30fc\u30c8", None)
        )
        self.cancelButton.setText(
            QCoreApplication.translate("TagDataImportDialog", "\u30ad\u30e3\u30f3\u30bb\u30eb", None)
        )
