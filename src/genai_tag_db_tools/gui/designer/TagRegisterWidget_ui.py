...
class Ui_TagRegisterWidget(object):
    ...
    def retranslateUi(self, TagRegisterWidget):
        TagRegisterWidget.setWindowTitle(
            QCoreApplication.translate("TagRegisterWidget", "\u30bf\u30b0\u767b\u9332", None)
        )
