...
class TagReaderProtocol(Protocol):
    ...
    def search_tags_bulk_all(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_usage_counts_batch(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_format_id(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_format_name(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_format_map(self, *args: Any, **kwargs: Any) -> Any: ...
    ...
    def list_tag_rows_by_length(self, *args: Any, **kwargs: Any) -> Any: ...
    def get_preferred_translations_batch(self, *args: Any, **kwargs: Any) -> Any: ...
...
class TagWriterProtocol(Protocol):
    ...
    def set_preferred_translation(self, *args: Any, **kwargs: Any) -> Any: ...
    def clear_preferred_translation(self, *args: Any, **kwargs: Any) -> Any: ...
