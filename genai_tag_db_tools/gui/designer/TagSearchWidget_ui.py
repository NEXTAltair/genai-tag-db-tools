...
class Ui_TagSearchWidget(object):
    def setupUi(self, TagSearchWidget):
        ...
        sizePolicy2.setHeightForWidth(
            self.tabWidgetResults.sizePolicy().hasHeightForWidth()
        )
    ...
    def retranslateUi(self, TagSearchWidget):
        TagSearchWidget.setWindowTitle(
            QCoreApplication.translate(
                "TagSearchWidget", "\u30bf\u30b0\u691c\u7d22", None
            )
        )
        self.groupBoxSearchCriteria.setTitle(
            QCoreApplication.translate(
                "TagSearchWidget", "\u691c\u7d22\u6761\u4ef6", None
            )
        )
        ...
        self.groupBoxMatchType.setTitle(
            QCoreApplication.translate(
                "TagSearchWidget", "\u4e00\u81f4\u30bf\u30a4\u30d7", None
            )
        )
        self.radioButtonExact.setText(
            QCoreApplication.translate(
                "TagSearchWidget", "\u5b8c\u5168\u4e00\u81f4", None
            )
        )
        self.radioButtonPartial.setText(
            QCoreApplication.translate(
                "TagSearchWidget", "\u90e8\u5206\u4e00\u81f4", None
            )
        )
        self.labelFormat.setText(
            QCoreApplication.translate(
                "TagSearchWidget", "\u30d5\u30a9\u30fc\u30de\u30c3\u30c8:", None
            )
        )
        self.labelType.setText(
            QCoreApplication.translate("TagSearchWidget", "\u30bf\u30a4\u30d7:", None)
        )
        self.labelLanguage.setText(
            QCoreApplication.translate("TagSearchWidget", "\u8a00\u8a9e:", None)
        )
        self.labelUsageCount.setText(
            QCoreApplication.translate(
                "TagSearchWidget", "\u4f7f\u7528\u56de\u6570:", None
            )
        )
        self.pushButtonSearch.setText(
            QCoreApplication.translate("TagSearchWidget", "\u691c\u7d22", None)
        )
