...
# リファクタ後のサービスクラス
from genai_tag_db_tools.services.app_services import TagCoreService, TagImportService
...
def test_import_service_execution(monkeypatch, db_session):
    ...
    # インポート実行
    config = ImportConfig(format_id=1, language="ja", column_names=["source_tag", "col2"])
