...
def test_search_tags(tag_searcher):
    result = tag_searcher.search_tags("example", match_mode='partial', format_name='All')
...
def test_update_tag_status(tag_searcher):
    ...
    updated_tag_id = tag_searcher.update_tag_status(tag_id, format_id, type_id, alias, preferred_tag_id)
